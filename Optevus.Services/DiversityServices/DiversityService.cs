...
namespace Optevus.Services.DiversityServices
{
    public class DiversityService : IDiversityService
    {
        ...
        public async Task<ResponseDiversitySchool?> GetDiversitySchool(int jobId)
        {
            var diversitySchool = await _diversityRepository.GetDiversitySchool(jobId);
        ...
        public async Task<List<ResponseAgeAggregate>?> GetApplicantAgeRanges(int jobId)
        {
        ...
        public async Task<ResponseEthnicityAggregate?> GetApplicantEthnicity(int jobId)
        {
        ...
        public async Task<ResponseJobDiversityStatistics> GetJobApplicant(int jobId)
        {
